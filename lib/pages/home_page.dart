    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          title: const Text(
            'Menu',
            style: TextStyle(color: Colors.black, fontSize: 36, fontFamily: 'Poppins', fontWeight: FontWeight.w700),
          ),
          actions: const [
            CircleAvatar(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                decoration: const BoxDecoration(color: Color.fromARGB(255, 224, 223, 223), borderRadius: BorderRadius.all(Radius.circular(32))),
                child: const Padding(
              ...
              const SizedBox(
                height: 130,
                child: Expanded(child: ScrollFood()),
              ),
